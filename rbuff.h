...
uint8_t rbuff_write_rb(rbuff_t *rbuff, rbuff_t *w_rbuff, uint32_t size);  //zrusit a nahradit moce a copy
uint32_t rbuff_read(rbuff_t *rbuff, uint8_t *buff, uint32_t size);

uint8_t rbuff_copy(rbuff_t *rbuff_dst, rbuff_t *rbuff_src, uint32_t size);
uint8_t rbuff_move(rbuff_t *rbuff_dst, rbuff_t *rbuff_src, uint32_t size);
